...
As the name suggests, GATTACA was originally written with microarray technology in mind, however it can be easily adapted to analyze RNA-Seq data as well.
