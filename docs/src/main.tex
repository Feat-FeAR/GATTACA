...
% Bibliograpy
    ...
    \addbibresource{resources/Transcriptomics.bib}
...
\title{\normalfont GATTACA Manual}
\author{Visentin Luca and Ruffinatti A. Federico, Ph.D.}
\date{December 2021}
...
\printbibliography[heading=bibintoc,title=Bibliograpy]
